...
public class DarkWizardEntity extends HostileEntity implements GeoEntity {

    private final AnimatableInstanceCache geoCache = GeckoLibUtil.createInstanceCache(this);

    public DarkWizardEntity(EntityType<? extends HostileEntity> entityType, World world) {
    ...
    private <T extends GeoAnimatable> PlayState predicate(AnimationState<T> tAnimationState) {
        ...
        if (this.isDead()) {
            // Only set the death animation if it's not already set
            if (!tAnimationState.getController().getCurrentAnimation().equals("death")) {

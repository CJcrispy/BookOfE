...
/**
 * Custom renderer for Moonveil sword that handles animated texture rendering.
 ...
 */
public class MoonveilItemRenderer {
    /**
     * Renders the Moonveil item with animated texture support.
    ...
    public static void render(ItemStack stack, ModelTransformationMode mode, MatrixStack matrices,
        ...
        ModelIdentifier modelId = new ModelIdentifier(Identifier.of(BookOfE.MOD_ID, "moon_sword"), "inventory");
